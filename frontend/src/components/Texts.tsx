...
export const CustomComponent: React.FC<CustomComponentProps> = ({
  ...
  const handleTitleFontSizeChange = (
    _event: Event,
  ...
  return (
    <ThemeProvider theme={theme}>
      <div>
        ...
        <FormControl className={classes.formControl}>
          <InputLabel id="title-font-select-label" style={{ color: "white" }}>
            Title Font
          </InputLabel>
          <Select
        ...
        <div>
          <FormControl className={classes.formControl}>
            <InputLabel id="title-color-label" style={{ color: "white" }}>
              Title Color
            </InputLabel>
            <Input
              type="color"
          ...
          <FormControl className={classes.formControl}>
            <InputLabel id="subtitle-color-label" style={{ color: "white" }}>
              Subtitle Color
            </InputLabel>
            <Input
              type="color"
